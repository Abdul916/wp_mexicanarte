<?php
//require(AVANTE_ELEMENTOR_PATH.'menu-item-custom-fields/menu-item-custom-fields.php');
 ...
 * @since 0.1.0
 */
class Avante_Menu_Item_Custom_Fields {
	...
	public static function init() {
		...
		self::$fields = array(
			'megamenu' => __( 'Elementor Mega Menu (optional)', 'avante-elementor' ),
		);
	}
	...
	public static function _fields( $id, $item, $depth, $args ) {
		...
		{
			$tg_footers_select[''] = __( 'No mega menu found. Please create one first', 'avante-elementor' );
		}
...
Avante_Menu_Item_Custom_Fields::init();