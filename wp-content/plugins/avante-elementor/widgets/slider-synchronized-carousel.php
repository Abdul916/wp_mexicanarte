 ...
 * @since 1.0.0
 */
class Avante_Slider_Synchronized_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'avante-slider-synchronized-carousel';
	}
	...
	public function get_title() {
		return __( 'Synchronized Carousel Slider', 'avante-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'momentum-slider', 'avante-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		**/
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Number', 'avante-elementor' ),
		...
		$this->add_control(
		    'number_color',
		    [
		        'label' => __( 'Number Color', 'avante-elementor' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Number Typography', 'avante-elementor' ),
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/slider-synchronized-carousel/index.php');
	}
