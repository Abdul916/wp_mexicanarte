 ...
 * @since 1.0.0
 */
class Avante_Portfolio_Masonry extends Widget_Base {
	...
	public function get_name() {
		return 'avante-portfolio-masonry';
	}
	...
	public function get_title() {
		return __( 'Portfolio Masonry', 'avante-elementor' );
	}
		...
		**/
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .portfolio-masonry-grid-wrapper figcaption' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#000000',
		        'selectors' => [
		            '{{WRAPPER}} .portfolio-masonry-grid-wrapper h3' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} div.portfolio-masonry-grid-wrapper h3',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .portfolio-masonry-content .portfolio_masonry_subtitle',
			]
		);
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/portfolio-masonry/index.php');
	}
