 ...
 * @since 1.0.0
 */
class Avante_Slider_Popout extends Widget_Base {
	...
	public function get_title() {
		return __( 'Fullscreen Popout Slider', 'avante-elementor' );
	}
		...
		**/
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Navigation Typography', 'avante-elementor' ),
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/slider-popout/index.php');
	}
