 ...
 * @since 1.0.0
 */
class Avante_Distortion_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Distortion Hover Grid', 'avante-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'imagesloaded', 'three', 'tweenmax', 'hover', 'avante-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		**/
		...
		$repeater->add_control(
			'slide_image_hover', [
				'label' => __( 'Image on hover', 'avante-elementor' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'slide_excerpt', [
				'label' => __( 'Excerpt', 'avante-elementor' ),
		...
		**/
		...
		$this->add_control(
		  'theme',
		  [
		     'label'       => __( 'Theme', 'avante-elementor' ),
		     'type' => Controls_Manager::SELECT,
		     'default' => 1,
		     'options' => [
			   1 => __( 'Theme 1', 'avante-elementor' ),
			   2 => __( 'Theme 2', 'avante-elementor' ),
			   3 => __( 'Theme 3', 'avante-elementor' ),
			   4 => __( 'Theme 4', 'avante-elementor' ),
			   5 => __( 'Theme 5', 'avante-elementor' ),
			   6 => __( 'Theme 6', 'avante-elementor' ),
			   7 => __( 'Theme 7', 'avante-elementor' ),
			   8 => __( 'Theme 8', 'avante-elementor' ),
			   9 => __( 'Theme 9', 'avante-elementor' ),
			   10 => __( 'Theme 10', 'avante-elementor' ),
			],
		  ]
		);
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/distortion-grid/index.php');
	}
