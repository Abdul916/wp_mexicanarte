 ...
 * @since 1.0.0
 */
class Avante_Slider_Flip extends Widget_Base {
	...
	public function get_title() {
		return __( 'Flip Slider', 'avante-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'mousewheel', 'avante-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		**/
		...
		$this->add_responsive_control(
		    'slide_width',
		    [
		        'label' => __( 'Slide Width', 'avante-elementor' ),
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/slider-flip/index.php');
	}
