 ...
 * @since 1.0.0
 */
class Avante_Slider_Vertical_Parallax extends Widget_Base {
	...
	public function get_name() {
		return 'avante-slider-vertical-parallax';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Vertical Parallax Slider', 'avante-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'lodash', 'avante-elementor' ];
	}
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/slider-vertical-parallax/index.php');
	}
