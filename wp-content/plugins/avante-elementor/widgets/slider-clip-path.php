 ...
 * @since 1.0.0
 */
class Avante_Slider_Clip_Path extends Widget_Base {
	...
	public function get_name() {
		return 'avante-slider-clip-path';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Clip Path Slider', 'avante-elementor' );
	}
	...
	protected function _register_controls() {
		...
		**/
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Navigation Arrow Color', 'avante-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#999999',
		        'selectors' => [
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/slider-clip-path/index.php');
	}
