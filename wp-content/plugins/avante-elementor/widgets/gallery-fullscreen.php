 ...
 * @since 1.0.0
 */
class Avante_Gallery_Fullscreen extends Widget_Base {
	...
	public function get_name() {
		return 'avante-gallery-fullscreen';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Gallery', 'avante-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_image',
			array(
				'label'      => esc_html__( 'Image', 'avante-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'cover',
			    'options' => [
			     	'contain' => __( 'Contain', 'avante-elementor' ),
			     	'cover' => __( 'Cover', 'avante-elementor' ),
			    ],
			]
		);
		...
		$this->add_control(
			'slideshow_content',
			[
				'label' => __( 'Image Content', 'avante-elementor' ),
				'type' => Controls_Manager::SELECT2,
				'default' => 'title',
			    'options' => [
			     	'title' => __( 'Title', 'avante-elementor' ),
			     	'caption' => __( 'Caption', 'avante-elementor' ),
			     	'description' 	=> __( 'Description', 'avante-elementor' ),
			    ],
			    'multiple' => true
			]
		);
		...
		$this->start_controls_section(
			'section_transition',
			array(
				'label'      => esc_html__( 'Transition', 'avante-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'effect',
			[
				'label' => __( 'Transition Effect', 'avante-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'slide',
			    'options' => [
			     	'slide' => __( 'Slide', 'avante-elementor' ),
			     	'fade' => __( 'Fade', 'avante-elementor' ),
			     	'cube' => __( 'Cube', 'avante-elementor' ),
			     	'coverflow' => __( 'Coverflow', 'avante-elementor' ),
			     	'flip' => __( 'Flip', 'avante-elementor' ),
			    ],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'hover',
			    'options' => [
			     	'hover' => __( 'On Hover', 'avante-elementor' ),
			     	'always' => __( 'Always', 'avante-elementor' ),
			     	'hide' => __( 'Hide', 'avante-elementor' ),
			    ],
			]
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Caption', 'avante-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
		    'caption_color',
		    [
		        'label' => __( 'Caption Color', 'avante-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Caption Typography', 'avante-elementor' ),
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/gallery-fullscreen/index.php');
	}
