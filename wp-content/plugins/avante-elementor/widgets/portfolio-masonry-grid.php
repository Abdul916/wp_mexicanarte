 ...
 * @since 1.0.0
 */
class Avante_Portfolio_Masonry_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'avante-portfolio-masonry-grid';
	}
	...
	public function get_title() {
		return __( 'Portfolio Masonry Grid', 'avante-elementor' );
	}
		...
		**/
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .portfolio-masonry-grid-wrapper img' => 'border-radius: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .portfolio-masonry-grid-wrapper' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .portfolio-masonry-container.masonry-grid .portfolio-masonry-grid-wrapper:after',
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#000000',
		        'selectors' => [
		            '{{WRAPPER}} .portfolio-masonry-container.masonry-grid .portfolio-masonry-grid-wrapper figcaption .overflow-inner h3' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .portfolio-masonry-container.masonry-grid .portfolio-masonry-grid-wrapper figcaption .overflow-inner h3',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'toggle' => true,
				'selectors' => [
		            '{{WRAPPER}} div.portfolio-masonry-grid-wrapper' => 'text-align: {{VALUE}}',
		        ],
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#B8B8B8',
		        'selectors' => [
		            '{{WRAPPER}} .portfolio-masonry-container.masonry-grid .portfolio-masonry-grid-wrapper figcaption .overflow-inner .portfolio-grid-subtitle' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .portfolio-masonry-container.masonry-grid .portfolio-masonry-grid-wrapper figcaption .overflow-inner .portfolio-grid-subtitle',
			]
		);
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/portfolio-masonry-grid/index.php');
	}
