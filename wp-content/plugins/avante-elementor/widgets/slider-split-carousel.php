 ...
 * @since 1.0.0
 */
class Avante_Slider_Split_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'avante-slider-split-carousel';
	}
	...
	public function get_title() {
		return __( 'Split Carousel Slider', 'avante-elementor' );
	}
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/slider-split-carousel/index.php');
	}
