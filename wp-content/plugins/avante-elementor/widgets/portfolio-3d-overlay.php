 ...
 * @since 1.0.0
 */
class Avante_Portfolio_3D_overlay extends Widget_Base {
	...
	public function get_name() {
		return 'avante-portfolio-3d-overlay';
	}
	...
	public function get_title() {
		return __( 'Portfolio 3D Overlay', 'avante-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'imagesloaded', 'avante-elementor' ];
	}
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/portfolio-3d-overlay/index.php');
	}
