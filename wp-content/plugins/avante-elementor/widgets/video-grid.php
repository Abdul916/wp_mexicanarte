 ...
 * @since 1.0.0
 */
class Avante_Video_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Video Grid', 'avante-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tweenmax', 'imagesloaded', 'avante-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		**/
		...
		$repeater->add_control(
			'slide_video_id', [
				'label' => __( 'Youtube Video ID', 'avante-elementor' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'description' => __( 'Enter Youtube video ID. You can get it from Youtube video URL ex. 7F37r50VUTQ', 'avante-elementor' ),
			]
		);
		...
		**/
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            ...
		            '{{WRAPPER}} div.avante-portfolio-filter-wrapper .filter-tag-btn:hover' => 'border-color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#000000',
		        'selectors' => [
		            '{{WRAPPER}} div.avante-portfolio-filter-wrapper .filter-tag-btn.active' => 'border-color: {{VALUE}}',
		            '{{WRAPPER}} .avante-portfolio-filter-wrapper a.filter-tag-btn.active' => 'color: {{VALUE}}',
		        ],
		    ]
		);
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/video-grid/index.php');
	}
