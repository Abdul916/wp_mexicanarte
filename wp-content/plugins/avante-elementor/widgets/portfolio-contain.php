 ...
 * @since 1.0.0
 */
class Avante_Portfolio_Contain extends Widget_Base {
	...
	public function get_name() {
		return 'avante-portfolio-contain';
	}
	...
	public function get_title() {
		return __( 'Portfolio Contain', 'avante-elementor' );
	}
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/portfolio-contain/index.php');
	}
