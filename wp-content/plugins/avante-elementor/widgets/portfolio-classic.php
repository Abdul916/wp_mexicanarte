 ...
 * @since 1.0.0
 */
class Avante_Portfolio_Classic extends Widget_Base {
	...
	public function get_name() {
		return 'avante-portfolio-classic';
	}
	...
	public function get_title() {
		return __( 'Portfolio Classic', 'avante-elementor' );
	}
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/portfolio-classic/index.php');
	}
