 ...
 * @since 1.0.0
 */
class Avante_Gallery_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Grid Gallery', 'avante-elementor' );
	}
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/gallery-grid/index.php');
	}
