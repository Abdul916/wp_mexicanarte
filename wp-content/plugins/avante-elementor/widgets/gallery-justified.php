 ...
 * @since 1.0.0
 */
class Avante_Gallery_Justified extends Widget_Base {
	...
	public function get_name() {
		return 'avante-gallery-justified';
	}
	...
	public function get_title() {
		return __( 'Justified Gallery', 'avante-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'justifiedGallery', 'avante-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    'row_height',
		    [
		        'label' => __( 'Row Height', 'avante-elementor' ),
		...
		$this->add_control(
			'justify_last_row',
			[
				'label' => __( 'Justify Last Row', 'avante-elementor' ),
	...
	protected function render() {
		include(AVANTE_ELEMENTOR_PATH.'templates/gallery-justified/index.php');
	}
