...
?>
<div class="slider-parallax-wrapper" data-autoplay="<?php echo intval($timer); ?>" data-pagination="<?php echo intval($pagination); ?>" data-navigation="<?php echo intval($navigation); ?>">
	<div class="slider_parallax_inner">
		...
		?>
				<div class="slide <?php if($count == 1) { ?>is-active<?php } ?> ">
		          	<div class="slide-content align-<?php echo esc_attr($settings['title_text_align']); ?>">
