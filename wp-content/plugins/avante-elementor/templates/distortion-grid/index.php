<?php
	...
	if(!empty($slides))
	{
		...
		$thumb_image_name = 'avante-gallery-list';
?>
<div class="distortion-grid-wrapper">
<?php		
		$count = 1;
...
?>
		<div class="distortion-grid-item distortion-grid-item--bg theme-<?php echo esc_attr($theme_code); ?>">
			<div class="distortion-grid-item-img" data-displacement="<?php echo plugins_url( '/avante-elementor/assets/images/distortion-grid/' ); ?><?php echo esc_attr($displacement); ?>" data-intensity="<?php echo esc_attr($intensity); ?>" <?php echo $speed_in; ?> <?php echo $speed_out; ?> <?php echo $additional_attr; ?>>
			...
			<div class="distortion-grid-item-content">
				<span class="distortion-grid-item-meta"><?php echo esc_html($slide['slide_subtitle']); ?></span>
				<h2 class="distortion-grid-item-title"><?php echo esc_html($slide['slide_title']); ?></h2>
				<div class="distortion-grid-item-subtitle">
					<span><?php echo esc_html($slide['slide_excerpt']); ?></span>
					<a class="distortion-grid-item-link" href="<?php echo esc_url($slide['slide_link']['url']); ?>" <?php echo esc_attr($target); ?>><?php echo esc_html($slide['slide_link_title']); ?></a>
				</div>
			</div>
		</div>
<?php
