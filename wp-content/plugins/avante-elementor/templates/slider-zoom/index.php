...
?>
<div class="slider-zoom-wrapper" data-autoplay="<?php echo intval($timer); ?>" data-pagination="<?php echo intval($pagination); ?>">
<?php		
		$count = 1;
...
?>
		<div class="slideshow-slide js-slider-home-slide" data-slide="<?php echo esc_attr($count); ?>">
						...
						<div class="slideshow-slide-background-wrap background-absolute">
							<div class="slideshow-slide-background background-absolute">
								<div class="slideshow-slide-image-wrap background-absolute">
									<div class="slideshow-slide-image background-absolute" style="background-image: url(<?php echo esc_url($image_url[0]); ?>);"></div>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="slideshow-slide-caption">
				<div class="slideshow-slide-caption-text">
					<div class="container js-parallax" data-speed="2" data-position="top">
						...
						<div class="slideshow-slide-desc"><?php echo esc_html($slide['slide_description']); ?></div>
						<?php 
							if(!empty($slide['slide_link']['url']))
							{
								$target = $slide['slide_link']['is_external'] ? 'target="_blank"' : '';
						?>
						<a class="slideshow-slide-caption-subtitle -load o-hsub -link" href="<?php echo esc_url($slide['slide_link']['url']); ?>" <?php echo esc_attr($target); ?>>
							<span class="slideshow-slide-caption-subtitle-label"><?php echo esc_html($slide['slide_link_title']); ?></span>
						</a>
						<?php
							}
						?>
