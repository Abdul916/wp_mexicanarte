...
?>
<div class="avante-gallery-grid-content-wrapper layout-<?php echo esc_attr($column_class); ?> <?php echo esc_attr($spacing_class); ?>">
<?php		
		$animation_class = '';
...
?>
		<div class="gallery-grid-item <?php echo esc_attr($column_class); ?> <?php echo esc_attr($last_class); ?> <?php if(!empty($tg_enable_lazy_loading)) { ?>lazy<?php } ?> smoove" data-delay="<?php echo intval($queue*150); ?>" data-minwidth="<?php echo esc_attr($smoove_min_width); ?>" data-scale-x="0" data-scale-y="0">
			<?php
				if($is_lighbox)	
				{
			?>
			...
			?>
				<img <?php echo avante_get_blank_img_attr(); ?> <?php echo esc_attr($return_attr['source']); ?>="<?php echo esc_url($thumb_image_url[0]); ?>" class="<?php echo esc_attr($return_attr['class']); ?>" alt="<?php echo esc_attr($image_alt); ?>" />
			<?php
