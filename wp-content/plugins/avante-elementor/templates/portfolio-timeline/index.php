...
?>
<div class="portfolio-timeline-wrapper cd-horizontal-timeline" data-spacing="<?php echo esc_attr($settings['timeline_spacing']['size']); ?>">
	<div class="timeline">
...
?>
			<li <?php if($counter == 0){ ?>class="selected"<?php } ?> data-date="<?php echo esc_attr(date("d/m/Y", strtotime($slide_date))); ?>">
				...
				?>
					<div class="portfolio-timeline-content <?php echo esc_attr($content_class); ?>">
						<?php
						...
						?>
							<div class="post-button-wrapper">
							    <a class="continue-reading portfolio-timeline-link" href="<?php echo esc_url($slide['slide_link']['url']); ?>" <?php echo esc_attr($target); ?> ><?php echo esc_html($slide['slide_link-label']); ?><span></span></a>
							</div>
					</div>
			</div>
			</li>
