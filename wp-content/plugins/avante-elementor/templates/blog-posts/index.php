	...
	if (have_posts()) : while (have_posts()) : the_post();
		...
		global $wp_query;
	   	...
	   	switch($settings['layout'])
	   	{
		   	case 'classic':
		   	default:
		   		include(AVANTE_ELEMENTOR_PATH.'/templates/blog-posts/classic.php');
		   	break;
		   	
		   	case 'grid':
		   		include(AVANTE_ELEMENTOR_PATH.'/templates/blog-posts/grid.php');
		   	break;
		   	
		   	case 'grid_no_space':
		   		include(AVANTE_ELEMENTOR_PATH.'/templates/blog-posts/grid_no_space.php');
		   	break;
		   	
		   	case 'masonry':
		   		include(AVANTE_ELEMENTOR_PATH.'/templates/blog-posts/masonry.php');
		   	break;
		   	
		   	case 'list':
		   		include(AVANTE_ELEMENTOR_PATH.'/templates/blog-posts/list.php');
		   	break;
		   	
		   	case 'list-circle':
		   		include(AVANTE_ELEMENTOR_PATH.'/templates/blog-posts/list-circle.php');
		   	break;
		   	
		   	case 'metro':
		   		include(AVANTE_ELEMENTOR_PATH.'/templates/blog-posts/metro.php');
		   	break;
		   	
		   	case 'metro_no_space':
		   		include(AVANTE_ELEMENTOR_PATH.'/templates/blog-posts/metro_no_space.php');
		   	break;
	   	}
...
<?php
	if($settings['show_pagination'] == 'yes')
	{
		...
		if($wp_query->max_num_pages > 1)
	    {
	    	...
	    	{
	    	    avante_pagination($wp_query->max_num_pages, 4, 'blog-posts-'.$settings['layout'] );
	    	}
	    	else
	    	{
?>
