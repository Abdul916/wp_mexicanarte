...
<div class="avante-portfolio-filter-wrapper">
	...
	<?php
		...
		{
	?>
		<a class="filter-tag-btn" href="javascript:;" data-rel="<?php echo avante_sanitize_title(ltrim($filterable_tag)); ?>" data-cols="<?php echo esc_attr($settings['columns']['size']); ?>"><?php echo esc_html($filterable_tag); ?></a>
	<?php
		}
	?>
</div>
