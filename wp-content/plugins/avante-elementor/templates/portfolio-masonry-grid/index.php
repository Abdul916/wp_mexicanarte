<div class="portfolio-masonry-container masonry-grid">
<?php
...
?>
<div class="portfolio-masonry-content-wrapper avante-gallery-grid-content-wrapper do-masonry portfolio_masonry layout-<?php echo esc_attr($column_class); ?>" data-cols="<?php echo esc_attr($settings['columns']['size']); ?>">
<?php		
		$animation_class = '';
