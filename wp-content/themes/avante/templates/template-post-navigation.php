...
<div class="post-navigation previous">
	<a href="<?php echo esc_url(get_permalink($prev_post->ID)); ?>">
		<div class="navigation-post-content">
			...
			<div class="post-featured-image static">
			    <div class="post-featured-image-hover <?php if(!empty($tg_enable_lazy_loading)) { ?>lazy<?php } ?>">
			     	<?php 
				     	$blog_featured_img_url = get_the_post_thumbnail_url($prev_post, 'avante-gallery-list'); 
				     	$blog_featured_img_data = wp_get_attachment_image_src(get_post_thumbnail_id($prev_post->ID), "avante-gallery-list" );
				     	...
				     	{
				     ?>
				     <img <?php echo avante_get_blank_img_attr(); ?> <?php echo esc_attr($return_attr['source']); ?>="<?php echo esc_url($blog_featured_img_url); ?>" class="<?php echo esc_attr($return_attr['class']); ?> smoove" alt="<?php echo esc_attr($blog_featured_img_alt); ?>"/>
				     <?php
					     }
					?>
			    </div>
		...
		<div class="navigation-anchor">
			<?php esc_html_e('Previous Article', 'avante' ); ?>
		</div>
	</a>
</div>
<?php
	...
	<a href="<?php echo esc_url(get_permalink($next_post->ID)); ?>">
		<div class="navigation-post-content">
			...
			<div class="post-featured-image static">
			    <div class="post-featured-image-hover <?php if(!empty($tg_enable_lazy_loading)) { ?>lazy<?php } ?>">
			     	<?php 
				     	$blog_featured_img_url = get_the_post_thumbnail_url($next_post, 'avante-gallery-list'); 
				     	$blog_featured_img_data = wp_get_attachment_image_src(get_post_thumbnail_id($next_post->ID), "avante-gallery-list" );
		...
		<div class="navigation-anchor">
			<?php esc_html_e('Next Article', 'avante' ); ?>
		</div>
	</a>
</div>
<?php	
