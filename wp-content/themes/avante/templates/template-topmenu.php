...
<div class="top-menu-bar <?php if(!empty($page_menu_transparent)) { ?>hasbg<?php } ?>">
		...
		<div id="logo-right-wrapper">
		    ...
		    <?php
			    ...
			    $woocommerce = avante_get_woocommerce();
			    $cart_url = wc_get_cart_url();
			    $cart_counter = $woocommerce->cart->cart_contents_count;
			?>
			<div class="menu-cart-wrapper">
			    <div class="cart-counter"><?php echo esc_html($cart_counter); ?></div>
			    <a class="tooltip" href="<?php echo esc_url($cart_url); ?>" title="<?php esc_attr_e('View Cart', 'avante' ); ?>"><span class="ti-shopping-cart"></span></a>
			</div>
			<?php
			}
			?>
    	...
    	<?php
    	    ...
    	    $tg_retina_transparent_logo = get_theme_mod('tg_retina_transparent_logo', avante_get_demo_logo('tg_retina_transparent_logo'));
    		...
    		<div class="logo-alignment">
	    	    <a id="custom_logo_transparent" class="logo-wrapper <?php if(empty($page_menu_transparent)) { ?>hidden<?php } else { ?>default<?php } ?>" href="<?php echo esc_url(home_url('/')); ?>">
					...
					<?php
						...
						{
					?>
	    	    	<img src="<?php echo esc_url($tg_retina_transparent_logo); ?>" alt="<?php esc_attr(get_bloginfo('name')); ?>" class="custom-logo-size"/>
	    	    	<?php 
		    	    	}
						else
						{
