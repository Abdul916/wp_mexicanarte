    ...
    <div class="standard-wrapper">
        ...
        <div id="logo_right_wrapper">
			...
			<?php
			    ...
			    $cart_counter = count($woocommerce->cart->cart_contents);
			?>
			<div class="menu-cart-wrapper">
			    <div class="cart-counter"><?php echo esc_html($cart_counter); ?></div>
			    <a href="<?php echo esc_url($cart_url); ?>" title="<?php esc_attr_e('View Cart', 'avante' ); ?>"><span class="ti-shopping-cart"></span></a>
			</div>
			<?php
			}
			?>
