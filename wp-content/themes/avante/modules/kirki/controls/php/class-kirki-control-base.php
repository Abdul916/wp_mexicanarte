...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'avante' ),
				'remove'         => esc_attr__( 'Remove', 'avante' ),
				'default'        => esc_attr__( 'Default', 'avante' ),
				'selectFile'     => esc_attr__( 'Select File', 'avante' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'avante' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'avante' ),
			)
		);
