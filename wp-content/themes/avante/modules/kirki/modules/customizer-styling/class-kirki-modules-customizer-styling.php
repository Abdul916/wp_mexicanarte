...
class Kirki_Modules_Customizer_Styling {
	...
	public function custom_css() {
		...
		.wp-core-ui .wp-full-overlay .collapse-sidebar {
			background: <?php echo esc_html($back); // WPCS: XSS ok. ?>;
			background-color: <?php echo esc_html($back); // WPCS: XSS ok. ?>;
			color: <?php echo esc_html($text_on_back); // WPCS: XSS ok. ?>;
		}
		...
		#customize-sidebar-outer-content {
			border-left-color: <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
			border-right-color: <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
		}
		...
		.customize-section-title {
			border-bottom-color: <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
		}
		...
		.expanded .wp-full-overlay-footer {
			color: <?php echo esc_html($text_on_back); // WPCS: XSS ok. ?>;
			background-color: <?php echo esc_html($back_on_back); // WPCS: XSS ok. ?>;
			border-color: <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
		}

		.accordion-section,
		#customize-theme-controls .customize-pane-child.accordion-section-content {
			background: <?php echo esc_html($back_on_back); // WPCS: XSS ok. ?>;
		}
		...
		#customize-theme-controls .control-section.open {
			border-bottom-color: <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
			border-top-color: <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
		}
		...
		#customize-theme-controls .accordion-section-title:after {
			color: <?php echo esc_html($arrows_on_back); // WPCS: XSS ok. ?>;
		}
		...
		.wp-core-ui .button-secondary {
			background-color: <?php echo esc_html($back); // WPCS: XSS ok. ?>;
			border-color: <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
			box-shadow: 0 1px 0 <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
			-webkit-box-shadow: 0 1px 0 <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
			text-shadow: 0 -1px 1px <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>, 1px 0 1px <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>, 0 1px 1px <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>, -1px 0 1px <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
			color: <?php echo esc_html($text_on_back); // WPCS: XSS ok. ?>;
		}
		...
		.customize-control-kirki-slider input[type=range]::-webkit-slider-thumb {
			background-color:<?php echo esc_html($accent); // WPCS: XSS ok. ?>;
		}
		...
		.customize-control-kirki-slider input[type=range] {
			background: <?php echo esc_html($border_on_back); // WPCS: XSS ok. ?>;
		}
		...
		.kirki-reset-section .dashicons {
			color: <?php echo esc_html($back_on_back); // WPCS: XSS ok. ?>;
		}
		...
		.customize-section-back:hover {
			background: <?php echo esc_html($hover_on_back); // WPCS: XSS ok. ?>;
			color: <?php echo esc_html($accent); // WPCS: XSS ok. ?>;
			border-left-color: <?php echo esc_html($accent); // WPCS: XSS ok. ?>;
		}

		.customize-controls-close:hover {
			background-color: <?php echo esc_html($back); // WPCS: XSS ok. ?>;
			color: <?php echo esc_html($accent); // WPCS: XSS ok. ?>;
			border-color: <?php echo esc_html($accent); // WPCS: XSS ok. ?>;
		}
		...
		.wp-core-ui .button.button-primary {
			background-color: <?php echo esc_html($accent); // WPCS: XSS ok. ?>;
			border-color: <?php echo esc_html($border_on_accent); // WPCS: XSS ok. ?>;
			box-shadow: 0 1px 0 <?php echo esc_html($border_on_accent); // WPCS: XSS ok. ?>;
			-webkit-box-shadow: 0 1px 0 <?php echo esc_html($border_on_accent); // WPCS: XSS ok. ?>;
			text-shadow: 0 -1px 1px <?php echo esc_html($border_on_accent); // WPCS: XSS ok. ?>, 1px 0 1px <?php echo esc_html($border_on_accent); // WPCS: XSS ok. ?>, 0 1px 1px <?php echo esc_html($border_on_accent); // WPCS: XSS ok. ?>, -1px 0 1px <?php echo esc_html($border_on_accent); // WPCS: XSS ok. ?>;
			color: <?php echo esc_html($text_on_accent); // WPCS: XSS ok. ?>;
		}
		...
		.wp-core-ui .button.button-primary:disabled,
		.wp-core-ui .button.button-primary[disabled] {
			background-color: <?php echo esc_html($accent_disabled); // WPCS: XSS ok. ?> !important;
			border-color: <?php echo esc_html($border_on_accent_disabled); // WPCS: XSS ok. ?> !important;
			box-shadow: 0 1px 0 <?php echo esc_html($border_on_accent_disabled); // WPCS: XSS ok. ?> !important;
			-webkit-box-shadow: 0 1px 0 <?php echo esc_html($border_on_accent_disabled); // WPCS: XSS ok. ?> !important;
			text-shadow: 0 -1px 1px <?php echo esc_html($border_on_accent_disabled); // WPCS: XSS ok. ?>, 1px 0 1px <?php echo esc_html($border_on_accent_disabled); // WPCS: XSS ok. ?>, 0 1px 1px <?php echo esc_html($border_on_accent_disabled); // WPCS: XSS ok. ?>, -1px 0 1px <?php echo esc_html($border_on_accent_disabled); // WPCS: XSS ok. ?> !important;
			color: <?php echo esc_html($text_on_accent_disabled); // WPCS: XSS ok. ?> !important;
		}
