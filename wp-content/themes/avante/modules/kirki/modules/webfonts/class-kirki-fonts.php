...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'avante' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'avante' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'avante' ),
			'200'       => esc_attr__( 'Light 200', 'avante' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'avante' ),
			'300'       => esc_attr__( 'Book 300', 'avante' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'avante' ),
			'400'       => esc_attr__( 'Normal 400', 'avante' ),
			'regular'   => esc_attr__( 'Normal 400', 'avante' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'avante' ),
			'500'       => esc_attr__( 'Medium 500', 'avante' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'avante' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'avante' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'avante' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'avante' ),
			'700'       => esc_attr__( 'Bold 700', 'avante' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'avante' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'avante' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'avante' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'avante' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'avante' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'avante' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'avante' ),
		);
	}
